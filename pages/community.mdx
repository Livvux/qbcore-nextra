...
1. **[Follow on GitHub →](https://github.com/qbcore-framework)** - Star our repos and contribute
2. **[Read the Docs →](/docs)** - Learn about the framework
3. **[Try a Tutorial →](/docs/guides)** - Get hands-on experience
4. **[Share Your Project →](/community/showcase)** - Show us what you're building
