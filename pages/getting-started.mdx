...
If you want to jump straight into gameplay, a <a href="https://5mx.com/" target="_blank" rel="noopener">QBCore server template on 5mx</a> provides a maintained base that you can customize.
</Callout>
