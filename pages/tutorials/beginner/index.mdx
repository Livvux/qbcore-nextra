...
<Cards>
  ...
  >
    **⏱️ 90 mins** | Master FiveM development from zero to first working server with QBCore
  </Cards.Card>
  ...
  >
    **⏱️ 45 mins** | Complete Lua programming guide with FiveM-specific patterns and examples
  </Cards.Card>
</Cards>
