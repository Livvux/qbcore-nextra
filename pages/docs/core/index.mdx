...
<div className="my-8">
  <img 
    src="/images/architecture/qbcore-framework-overview.svg" 
    alt="QBCore Framework Architecture Diagram showing core components and their relationships"
    className="mx-auto max-w-full"
    width="900"
    height="600"
  />
  <p className="text-sm text-gray-600 mt-4 text-center">QBCore Framework Architecture - Core components and data flow</p>
</div>
