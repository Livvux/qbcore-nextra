...
If you prefer skipping manual setup, a <a href="https://5mx.com/" target="_blank" rel="noopener">QBCore server template from 5mx</a> comes pre-configured for popular hosts.
</Callout>
