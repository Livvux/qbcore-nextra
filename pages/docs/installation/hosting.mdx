...
<Callout type="info" title="Before you choose a provider">
Read the <a href="/docs/installation/linux" target="_blank" rel="noopener">Linux</a> or <a href="/docs/installation/windows" target="_blank" rel="noopener">Windows</a> installation guides so you know the system requirements.
</Callout>

<Callout type="tip" title="Pre-built option">
If you prefer skipping manual setup, a <a href="https://fivemx.com/" target="_blank" rel="noopener">QBCore server template from 5mx</a> comes pre-configured for popular hosts.
</Callout>
