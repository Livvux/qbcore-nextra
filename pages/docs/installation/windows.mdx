...
<div className="my-6">
  <img 
    src="/images/installation/mysql-download-windows.webp" 
    alt="MySQL download page for Windows installation"
    className="rounded-lg border shadow-md"
    width="800"
    height="450"
  />
  <p className="text-sm text-gray-600 mt-2 text-center">MySQL Community Server download page for Windows</p>
</div>
...
<div className="my-6">
  <img 
    src="/images/installation/mysql-installer-windows.webp" 
    alt="MySQL installer setup wizard on Windows"
    className="rounded-lg border shadow-md"
    width="800"
    height="600"
  />
  <p className="text-sm text-gray-600 mt-2 text-center">MySQL installer configuration wizard</p>
</div>
