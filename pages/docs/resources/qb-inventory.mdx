...
<div className="my-8">
  <img 
    src="/images/resources/qb-inventory-interface-overview.webp" 
    alt="QB-Inventory main interface showing player inventory, hotbar, and item details"
    className="mx-auto max-w-full rounded-lg border shadow-lg"
    width="900"
    height="600"
  />
  <p className="text-sm text-gray-600 mt-4 text-center">QB-Inventory main interface with drag-and-drop functionality</p>
</div>
