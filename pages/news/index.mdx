...
**[Visit Eclipse RP →](https://discord.gg/eclipserp)**
...
**[Join Discord for Meeting Link →](https://discord.gg/qbcore)**
...
- **Discord Notifications**: Instant updates in our community server
- **GitHub Releases**: Watch our repositories for release notifications

### Social Media
- **Discord**: [QBCore Community Server](https://discord.gg/qbcore)
