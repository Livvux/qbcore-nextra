/**
 * Amazon Product Card Server Component
 * Displays Amazon products with affiliate links and compliance features
 */
 ...
 * Server Component that fetches product data and renders with proper affiliate compliance
 */
export default async function AmazonCard({
  asin,
  market = 'DE',
  variant = 'card',
  ...
  try {
    const product = await getProduct(asin, market)
    ...
    console.error('Error rendering Amazon card:', error)
