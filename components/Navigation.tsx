            ...
            <div className="flex h-16 items-center justify-between">
              ...
              <nav className="hidden md:flex items-center space-x-8">
                {navigationItems.map((item) => (
                  <Link
                    key={item.href}
                    href={item.href}
                    className="text-sm font-medium text-gray-300 transition-colors hover:text-qbcore relative group"
                  >
                    {item.label}
                    <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-qbcore transition-all duration-300 group-hover:w-full" />
                  </Link>
                ))}
              </nav>
              ...
              <div className="hidden md:flex items-center gap-4">
                ...
                <Link
                  ...
                  className="rounded-lg bg-qbcore px-4 py-2 text-sm font-semibold text-white transition-all duration-300 hover:bg-qbcore/80 hover:scale-105"
                >
                  Get Started
                </Link>
              </div>
